...
Once installed simply run ~M-x git-riddance~ and you will be prompted for the relevant information. All the defaults are configurable and open for extension/configuration.
